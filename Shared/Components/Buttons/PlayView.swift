...
struct PlayShape: Shape {
    func path(in rect: CGRect) -> Path {
        ...
        path.move(to: CGPoint(x: 0.73444*width, y: 0.26964*height))
        ...
        path.addCurve(to: CGPoint(x: 0.01539*width, y: 0.81536*height), control1: CGPoint(x: 0.0111*width, y: 0.71833*height), control2: CGPoint(x: 0.0111*width, y: 0.77327*height))
